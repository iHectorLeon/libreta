  ...
  */
  public questions(){
    ...
    if(this.block.data.questionnarie.type != 'test'){
      ...
      console.log(this.answers_v1Array);
        ...
        for(let id of idAnsQue.result){
          ...
          for(let idAnsStu of this.answerStudent){
            if(id.type == idAnsStu.type && id.index == idAnsStu.index && id.indexquestions == idAnsStu.indexquestions){
              ...
              if((idAnsStu.type=="text" || idAnsStu.type=="group") && this.filterString(id.answer) == this.filterString(idAnsStu.answer)){
                this.gradefinal++
    ...
    if(Array.isArray(value)){
      for(let element of value){
        ...
        if(element.length == 0){
          ...
          if(element.search("´")==0||element.search("`")==0||element.search("’")==0){
            console.log(element)
            return element.trim();
          }
        }
