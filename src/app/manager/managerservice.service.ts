...
export class ManagerserviceService {
  ...
  */
  public getGroupsManager(ou:any):Observable<any>{
    ...
    return this.http.get(this.url+'api/v1/requester/group/list?ou='+ou, headers)//.map(res=>res.json());
  }
  ...
  */
  public getGroupsforParent(idcourse, parent):Observable<any>{
    ...
    return this.http.get(this.url+'api/v1/requester/report/groupsquery?course='+idcourse+'&parent='+parent, headers)//.map(res=>res.json());
  }
  ...
  postGroup(groupSave):Observable<any>{
    ...
    console.log(params);
    return this.http.post(this.url+'api/v1/requester/group/create', params, headers)//.map(res=>res.json());
  }
  ...
  modifyGroup(groupModify):Observable<any>{
    ...
    return this.http.put(this.url+'api/v1/requester/group/modify', params, headers)//.map(res=>res.json());
  }
  ...
  getCodeGroup(codegroup):Observable<any>{
    ...
    return this.http.get(this.url+'api/v1/requester/group/listroster?code='+codegroup, headers)//.map(res=>res.json());
  }
  ...
  */
  getNewRequest(request):Observable<any>{
    ...
    return this.http.post(this.url+'api/v1/requester/request/create',request,headers)//.map(res=>res.json());
  }
  ...
  */
  deletedRequest(request):Observable<any>{
    ...
    return this.http.put(this.url+"api/v1/requester/request/cancel", params,headers)//.map(res=>res.json());
  }

  //metodo para obtener las carreras en base a area de educacion
  getCarreras(org:string):Observable<any>{
    return this.http.get(this.url+'api/career/list?org='+org+"&limit=50")//.map(res=>res.json());
  }
  ...
  getRequestsManager():Observable<any>{
    ...
    return this.http.get(this.url+"api/v1/requester/request/my?active=false",headers)//.map(res=>res.json());
  }
  ...
  getRequestFinder(numberrequest):Observable<any>{
    ...
    return this.http.get(this.url+'api/v1/requester/request/get?number='+numberrequest, headers)//.map(res=>res.json());
  }
  ...
  updateRequestManager(request):Observable<any>{
    ...
    return this.http.put(this.url+"api/v1/requester/request/modify", params,headers)//.map(res=>res.json());
  }
  ...
  sendMailRequestManager(bodyemail):Observable<any>{
    ...
    return this.http.post(this.url+"api/v1/requester/request/sendemail", params,headers)//.map(res=>res.json());
  }
  ...
  closeRequestManager(request):Observable<any>{
    ...
    return this.http.put(this.url+"api/v1/requester/request/finish", params,headers)//.map(res=>res.json());
  }
  ...
  getUserDetailsByManager(username):Observable<any>{
    ...
    return this.http.get(this.url+"api/v1/requester/user/getdetails?username="+username, headers)//.map(res=>res.json());
  }
  ...
  getFiscalDetailsByManager(name):Observable<any>{
    ...
    return this. http.get(this.url+"api/v1/requester/user/getdetails?username="+name,headers)//.map(res=>res.json());
  }
  ...
  createuserbymanager(usermuir):Observable<any>{
    ...
    return this.http.post(this.url+"api/v1/requester/user/muir", params,headers)//.map(res=>res.json());
  }
  ...
  createroosterbymanager(roosters):Observable<any>{
    ...
    return this.http.put(this.url+"api/v1/requester/group/createroster", params,headers)//.map(res=>res.json());
  }
  ...
  getrfccorporate():Observable<any>{
    ...
    return this.http.get(this.url+"api/v1/requester/fiscal/list", headers)//.map(res=>res.json());
  }
  ...
  */
  setAttachment(file, dir1:any, dir2:any, token:any):Observable<any>{
    ...
    return this.http.post(this.url + 'api/v1/file/upload?dir1='+dir1+'&dir2='+dir2, formData,headers)//.map(res=>res.json());
  }
  ...
  */
  sendPayment(payment):Observable<any>{
    ...
    console.log(params);
    return this.http.post(this.url+'api/v1/requester/request/setpayment', params, headers)//.map(res=> res.json());
  }
